...
6. Verifica che la cartella `bonus-ai-ready-premium-kit` sia visibile e che il README si veda nella pagina main.
...
1. Apri il README del kit su GitHub: https://github.com/responsabile2014-alt/python-da-zero-notebook/blob/main/bonus-ai-ready-premium-kit/README.md
...
3. Se un link dà errore 404, controlla che:
   ...
   - il branch si chiami **main**;
   - il percorso `bonus-ai-ready-premium-kit/06_Notebook_Colab/` sia corretto.

## Importante sul branch

I link "Apri in Colab" usano il branch **main**. Se il tuo repository usa un branch diverso da **main**, sostituisci `blob/main/` con il nome effettivo del branch nei link del README.
